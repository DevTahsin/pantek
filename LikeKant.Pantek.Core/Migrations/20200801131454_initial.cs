        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HTTPRequestHeaders = table.Column<string>(maxLength: 4000, nullable: true),
                    HttpRequestBody = table.Column<string>(maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Id", "Code", "FlagUrl", "IsDefault", "IsDeleted", "Name" },
                values: new object[,]
                {
                    { 1, "en", "https://www.countryflags.io/us/flat/64.png", false, false, "English" },
                    { 2, "tr", "https://www.countryflags.io/tr/flat/64.png", true, false, "Turkish" },
                    { 3, "zh-hans", "https://www.countryflags.io/cn/flat/64.png", false, false, "China" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "FirstName", "LastName", "Password", "Username" },
                values: new object[] { 1, "Volkan", "Alacaoğlu", "sa123!", "admin" });
